...
// configuration step. It creates a namespace called `project_small_game`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", project_small_game::cmake::project_name, project_small_game::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", project_small_game::cmake::project_version);
      return EXIT_SUCCESS;
    }
